window.addEventListener("DOMContentLoaded",function(){var form=document.getElementById("contact-form");var button=document.getElementById("contact-form-button");var status=document.getElementById("contact-form-status");function success(){form.reset();button.style="display: none ";status.innerHTML="감사합니다. 운영일 기준 2일 내로 문의주신 내용에 대해 답변드릴 수 있도록 하겠습니다.";}
function error(){status.innerHTML="죄송합니다. 문제가 발생했습니다. 잠시 후 다시 시도해 주세요.";}
