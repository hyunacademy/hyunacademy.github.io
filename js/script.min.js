...
var destName="현간호학원";var lat=36.63406529171746;var long=127.45108116483932;var mapContainer=document.getElementById('map'),mapOption={center:new kakao.maps.LatLng(lat,long),level:3};var map=new kakao.maps.Map(mapContainer,mapOption);var markerPosition=new kakao.maps.LatLng(lat,long);var marker=new kakao.maps.Marker({position:markerPosition});marker.setMap(map);var content=`
  <div class="customoverlay">
    <a href="https://map.kakao.com/link/to/${destName},${lat},${long}" target="_blank">
