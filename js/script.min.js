...
`;var position=new kakao.maps.LatLng(lat-.0003,long+.000015);var customOverlay=new kakao.maps.CustomOverlay({map:map,position:position,content:content,yAnchor:1});